    ...
    return (
        <Layout>
            <main className="about-page">
                <div className="col-2">
                    <img src={ProfiloImg} alt={'Profilo'} />
                    <div>
                ...
                <div className="col">
                    <p>
                        ...
                        Con il nostro <strong>approccio multidisciplinare</strong> affrontiamo diversi aspetti della progettazione che vanno dal design, agli aspetti agronomici, alla scelta di materiali e arredi, in un processo di trasformazione degli spazi
                        aperti. <br />
                        <strong>Dinamismo, velocità, e presenza diffusa sul territorio</strong> (Veneto, Lombardia, Marche, Toscana) ci permettono di rispondere tempestivamente alle esigenze del cliente, affiancandolo anche nella fase realizzativa,
                    ...
                    <ul>
                        ...
                        <li><strong>promuoviamo un basso impatto ambientale</strong> privilegiando l’utilizzo di materiali locali ed ecocompatibili e scegliendo specie resilienti a bassa manutenzione, con particolare attenzione alle esigenze idriche</li>
